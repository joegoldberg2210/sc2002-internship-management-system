...
public class InternshipOpportunity {
    ...
    private Date openDate;                     // Opening date for applications
    private Date closeDate;                    // Closing date for applications
    ...
    public InternshipOpportunity(String id, String title, String description, InternshipLevel level,
                                 String preferredMajor, Date openDate, Date closeDate,
    ...
    public boolean isOpenFor(Student student, Date today) {
        return visibility
                && status == OpportunityStatus.APPROVED
                && today.after(openDate)
                && today.before(closeDate);
    }
    ...
    public void setRepInCharge(CompanyRepresentative repInCharge) { this.repInCharge = repInCharge; }
